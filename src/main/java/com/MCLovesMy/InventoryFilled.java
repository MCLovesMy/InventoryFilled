...
import com.MCLovesMy.Updaters.Updater;
	...
	public class InventoryFilled extends JavaPlugin implements CommandExecutor {
		...
		//Moet nu alert2, 3 en 4 voor Part warning doen
		...
		public void onEnable() {
	        ...
	        getServer().getScheduler().runTaskLaterAsynchronously(this, new Runnable() {
	            public void run() {
	            	...
	            	console.sendMessage(ChatColor.RED + "[InventoryFilled] WARNING: " + ChatColor.WHITE + "IF YOU UPDATED FROM BELOW V1.4.0, PLEASE REMOVE ALL THE INVENTORYFILLED FILES! "
	            			+ " YOU CAN FIND THESE FILES IN /PLUGINS/INVENTORYFILLED! "
	            			+ "IF YOU DON'T DO THIS, INVENTORYFILLED WILL BE BUGGED!");
	                checkUpdate();
	        	    console.sendMessage(ChatColor.BLUE + "============================================");
	            }
	        }, 20L);
		    ...
		    try {
		    	...
		    	console.sendMessage(ChatColor.RED + "InventoryFilled ERROR: Stats about your server couldn't be send to MCStats.org!");
		    }
		}
